          ...
          Expanded(
              child: controller.imagem != null
                  ? GestureDetector(
                      ...
                      /* () async {
                      bool excluirImagem = await Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  VisualizarImagemPage(_image)));
                      if (excluirImagem != null && excluirImagem)
                        setState(() {
                          _image = null;
                        });
                    },
                  )
                : widget.bem?.imagem != null
                    ? GestureDetector(
                        onTap: () async {
                          bool alterarImagem = await Navigator.of(context).push(
                              MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      VisualizarImageFirestore(widget.bem)));
                          if (alterarImagem != null && alterarImagem)
                            getImage();
                        },
                        child: Hero(
                          tag: widget.bem.id,
          ...
          Container(
              ...
              child: RaisedButton(
                  ...
                  onPressed: _image != null
                      ? () async {
                          bool excluirImagem = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      VisualizarImagemPage(_image)));
